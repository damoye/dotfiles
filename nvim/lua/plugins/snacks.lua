...
return {
  ...
  keys = {
    ...
    { "<Leader>fG", function() Snacks.picker.grep({ root = false, exclude = {"*_test.go"} }) end, desc = "Grep exclude Tests" },
    { "<Leader>fw", function() Snacks.picker.grep_word({ root = false }) end, desc = "Find Selection or Word", mode = { "n", "x" } },
    { "<Leader>fW", function() Snacks.picker.grep_word({ root = false, exclude = {"*_test.go"} }) end, desc = "Find Selection or Word exclude Tests", mode = { "n", "x" } },
